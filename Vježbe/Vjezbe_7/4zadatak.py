...
print("Sredina (sa pogreškama) =", sredina1)
print("Medijan (sa pogreškama) =", medijan1)
...
print("\nSredina (bez pogrešaka) =", sredina2)
print("Medijan (bez pogrešaka) =", medijan2)
...
plt.title("Histogram svih mjerenja (sa i bez pogrešaka)")
